...
int main()
{
    ...
    try{
    cout << "Se tentar sacar 12000 reais..." << endl;
    contaNormal.sacar(12000);
    cout << "O novo saldo vale " << contaNormal.getSaldo() << " reais" << endl;
    }catch(SaldoNaoDisponivelException salExc){
        salExc = SaldoNaoDisponivelException();
    }
